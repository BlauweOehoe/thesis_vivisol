...
df_Logistic1 <- glm(post_Compliant__c ~ analysis_email + n_case_communications + comm_timeframe, data = df)
...
df_Logistic4 <- glm(post_Compliant__c ~ analysis_email + analysis_call + analysis_Letter + n_case_communications + comm_timeframe, data = df)
